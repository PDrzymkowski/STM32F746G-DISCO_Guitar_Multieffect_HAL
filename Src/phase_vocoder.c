...
float32_t x_in_temp[FFT_SIZE] = {0};
float32_t x_out_temp[OUT_TEMP_BUF_SIZE]= {0};
float32_t x_out_resampled[X_OUT_RESAMPLED_SIZE]= {0};
...
float32_t hann512[512] = {0};
float32_t hann_sqrt[] = hann_sqrt_1024_samples;

//float32_t hann512[512];
float32_t hannScaled[1024] = {0};
float32_t omegaNominal[FFT_SIZE/2] = {0};
float32_t deltaPhiExpected[FFT_SIZE/2] = {0};
float32_t x_in[FFT_SIZE] = {0};

// Analiza
float32_t X_fft_in[FFT_SIZE] = {0};
float32_t A_in[FFT_SIZE/2] = {0};
float32_t phi_in[FFT_SIZE/2] = {0};

// Modyfikacja
float32_t phiInPrevious[FFT_SIZE/2] = {0};
float32_t phiOutPrevious[FFT_SIZE/2] = {0};
float32_t deltaPhi[FFT_SIZE/2] = {0};
float32_t deltaPhiUnwrap[FFT_SIZE/2] = {0};
float32_t omegaIn[FFT_SIZE/2] = {0};

// Synteza
float32_t phi_out[FFT_SIZE/2] = {0};
float32_t X_fft_out[FFT_SIZE] = {0};
float32_t x_out[FFT_SIZE] = {0};
