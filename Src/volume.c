...
void Display_Current_Volume(void)
{
	  ...
	  BSP_LCD_SetBackColor(LCD_COLOR_LIGHTGRAY);
		...
		BSP_LCD_DisplayStringAt(VOLUME_DOWN_BUTTON_XPOS+VOLUME_BUTTON_WIDTH+35, VOLUME_BUTTON_YPOS+(VOLUME_BUTTON_HEIGHT/2)-8, (uint8_t *)current_volume_str, LEFT_MODE);
}
